...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-06-2024 a las 22:55:52
...
INSERT INTO `compras` (`id`, `id_producto`, `id_proveedor`, `cantidad`, `fecha`) VALUES
(6, 5, 4, 5, '2024-06-06'),
(7, 5, 4, 2, '2024-06-07');
...
(4, 'Computadora', 'PC con 8 RAM', '1000.00', 5),
(5, 'Refrigeradora', 'Indurama con motor express', '8000.00', 2);
...
(4, 'Indurama', 'Juan Gabriel', '0983852222'),
(5, 'Lenovo', 'Esteban Muentes', '0984324770');
